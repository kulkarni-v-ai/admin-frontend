                            ...
                            <tr key={u._id} style={{ borderBottom: "1px solid var(--border-color)" }}>
                                ...
                                <td style={{ padding: "16px 20px", textAlign: "right", display: "flex", justifyContent: "flex-end", gap: "8px" }}>
                                    ...
                                    <button
                                        ...
                                        style={{
                                            padding: "8px", 
                                            backgroundColor: ((u.role === "superadmin" && currentUser?.username !== "devcobraaa") || u.username === "devcobraaa" || u._id === (currentUser?.id || currentUser?._id)) ? "rgba(255,255,255,0.05)" : "rgba(239, 68, 68, 0.1)",
                                            color: ((u.role === "superadmin" && currentUser?.username !== "devcobraaa") || u.username === "devcobraaa" || u._id === (currentUser?.id || currentUser?._id)) ? "#4b5563" : "#ef4444",
                                            border: "none", 
                                            borderRadius: "4px", 
                                            cursor: ((u.role === "superadmin" && currentUser?.username !== "devcobraaa") || u.username === "devcobraaa" || u._id === (currentUser?.id || currentUser?._id)) ? "not-allowed" : "pointer"
                                        }}
